...
function cubefromshape(args...; samplefactor=nothing, kwargs...)
  error("the cubefromshape function got removed from EarthDataLab.jl for compatibility resaons. Please use Rasters.rasterize from the Rasters.jl package instead.")
